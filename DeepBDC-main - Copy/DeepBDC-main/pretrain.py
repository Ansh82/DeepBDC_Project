...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', default=6, type=int, help='pre-training batch size')
    ...
    parser.add_argument('--model', default='ResNet12', choices=['ResNet12', 'ResNet18','ResNet50', 'EfficientResNet10'])
